...
\subsection{Tools}
Strings are a useful tool for getting all strings in a file, while hex editor gives a more detailed overview.
\paragraph{Volatility} is an open source collection of tools used to extract digital
