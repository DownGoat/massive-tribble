...
One of our experiments was to look into how a application that gives the user higher 
...
message in the memory dump like we did when tested against the stock SMS application. 
